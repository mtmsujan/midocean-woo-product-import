...
/**
 * Display color and quantity field conditionally
 */

if ( 'textile' === $this->type_of_product ) : ?>
            ...
            <div class="row mt-3 justify-content-start align-items-center color-input-row">
                ...
                <div class="col-sm-2">
                    <div class=" color-dropdown-wrapper">
                        ...
                        <button class="" type="button" id="colorDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="row align-items-center">
                                ...
                                <div class="col-8 color-name"><?= ucfirst( $this->color_group ); ?> -
                                </div>
                            </div>
                        </button>
                    </div>
